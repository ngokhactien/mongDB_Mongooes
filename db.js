...
//2 connect
mongoose.connect('mongodb://localhost/myDataBase', {useNewUrlParser: true, useUnifiedTopology: true});  //myDataBase là của db database (use myDataBase)
...
// //4 tao  model để kết nối dữ liệu 
 ...
 const user = mongoose.model('user' , userSchema);    //user là tên của model 
